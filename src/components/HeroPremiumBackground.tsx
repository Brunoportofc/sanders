...
// Clean background design - Light mode: clean white, Dark mode: deep blue with soft blue lights
const HeroPremiumBackground: React.FC = () => {
  return (
    <>
      ...
      {/* Interactive lights overlay - visible in both light and dark modes */}
...
export default HeroPremiumBackground;